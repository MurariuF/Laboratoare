...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            void First()
            {
                using (ModelSelfRefrences contex = new ModelSelfRefrences())
                {
                    ...
                    {
                        Name = "copil1",
                        ParentSelfReference = s1

                    };
                    SelfReference s3 = new SelfReference()
                    {
                        Name = "copil2",
                        ParentSelfReference = s1
                    ...
                    contex.SelfReferences.Add(s1);
                    contex.SelfReferences.Add(s2);
                    contex.SelfReferences.Add(s3);
                    contex.SaveChanges();

                    foreach (SelfReference var in contex.SelfReferences)
                    {
